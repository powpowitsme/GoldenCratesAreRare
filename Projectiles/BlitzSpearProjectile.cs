...
{
    public class BlitzSpearProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            projectile.position.X = ownerMountedCenter.X - (float)(projectile.width / 4);
            ...
            if (!projOwner.frozen)
            {
                ...
                if (projOwner.itemAnimation < projOwner.itemAnimationMax / 6)
                {
                    movementFactor -= 4.4f;
                }
                else
