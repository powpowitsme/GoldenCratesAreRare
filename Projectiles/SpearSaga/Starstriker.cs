        ...
        {
            {
                ...
                if (timer == 0)
                {
                    Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, projectile.velocity.X, projectile.velocity.Y, 9, 31, projectile.knockBack, projectile.owner, 0f, 0f);
                    timer = 20;
                }
            }
        }
